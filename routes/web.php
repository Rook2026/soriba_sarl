...
// Contact : affichage + traitement du formulaire
Route::get('/contact',  [FrontendController::class, 'contact'])->name('contact');
Route::post('/contact', [FrontendController::class, 'contactSend'])->name('contact.send');
Route::post('/contact', [FrontendController::class, 'contactShow'])->name('contact.show');
...
// ── Experts ──────────────────────────────────────────────────────────────
Route::get('/experts',          [FrontendController::class, 'experts'])->name('experts');
