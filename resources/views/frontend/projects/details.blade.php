...
<section class="py-12 bg-white">
    <div class="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        <div class="relative rounded-2xl overflow-hidden mb-12 shadow-lg">
            <div class="absolute inset-0 bg-gradient-to-br from-amber-900/20 to-dark-blue/40 flex items-center justify-center text-7xl">⚡</div>
            <div class="relative h-80 lg:h-96 bg-gradient-to-br from-amber-900/30 to-dark-blue/50 flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="prose prose-lg max-w-none prose-headings:text-dark-blue prose-p:text-gray-600 prose-strong:text-dark-blue prose-ul:text-gray-600 prose-li:text-gray-600">
                    ...
                    <div class="bg-light-blue rounded-2xl p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center text-lg">🇸🇳</div>
                                <div>
